        ...
        <label class="alignleft">
            ...
            <span class="input-text-wrap">
                <select name="pct_bulk_on_shelf">
                    ...
                    <option value="0">
                        <?php esc_html_e( 'Not on shelf', 'paint-tracker-and-mixing-helper' ); ?>
                    </option>
                </select>
            </span>
        </label>
        ...
        <label class="alignleft">
            ...
            <span class="input-text-wrap">
                <select name="pct_bulk_exclude_shade">
                    ...
                    <option value="1">
                        <?php esc_html_e( 'Exclude from shading', 'paint-tracker-and-mixing-helper' ); ?>
                    </option>
                    <option value="0">
                        <?php esc_html_e( 'Include in shading', 'paint-tracker-and-mixing-helper' ); ?>
                    </option>
                </select>
            </span>
        </label>
            ...
            <span class="input-text-wrap">
                <select name="pct_bulk_base_type">
                    ...
                    <option value="acrylic">
                        <?php esc_html_e( 'Set to Acrylic', 'paint-tracker-and-mixing-helper' ); ?>
                    </option>
                    <option value="enamel">
                        <?php esc_html_e( 'Set to Enamel', 'paint-tracker-and-mixing-helper' ); ?>
                    </option>
                    <option value="oil">
                        <?php esc_html_e( 'Set to Oil', 'paint-tracker-and-mixing-helper' ); ?>
                    </option>
                    <option value="lacquer">
                        <?php esc_html_e( 'Set to Lacquer', 'paint-tracker-and-mixing-helper' ); ?>
                    </option>
                </select>
            </span>
        </label>
